...
class TestCity_instantiation(unittest.TestCase):
    """
    This is the unittest for instantiation of the City class.
    """
...
class TestCity_save(unittest.TestCase):
    """
	This is the unittest for testing save method of the City class.
	"""
...
class TestCity_to_dict(unittest.TestCase):
    """
	This is the unittest for testing to_dict method of the City class.
	"""
