#!/usr/bin/python3
"""
These module for Amenity class unittest
"""
import os
import models
import unittest
...
class TestAmenity_instantiation(unittest.TestCase):
    """
    This Unittest is for testing instantiation of the Amenity class.
    """
    def setUp(self):
        try:
...
class TestAmenity_save(unittest.TestCase):
    """
    This is the Unittest for save method of the Amenity class.
    """
...
class TestAmenity_to_dict(unittest.TestCase):
    """
    This is the unittest for to_dict method of the Amenity class.
    """
    def setUp(self):
        try:
            os.rename("file.json", "tmp.json")
