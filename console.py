...
def split_curly_braces(e_arg):
    """
    This Splits the curly braces for the update method
    """
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_all(self, arg):
        """
        Print the str representation of all instances or a specific class.
        Usage: <User>.all()
                <User>.show()
        """
        objects = storage.all()
    ...
    def do_count(self, arg):
        """
        Counts and retrieves the numb of instances of a class
